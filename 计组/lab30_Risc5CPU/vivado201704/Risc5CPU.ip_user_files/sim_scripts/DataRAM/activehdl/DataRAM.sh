...
#
# Generated by Vivado on Thu Dec 23 13:59:58 +0800 2021
...
# Script info
echo -e "DataRAM.sh - Script generated by export_simulation (Vivado v2021.1.1 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/Modelsim/lab30_Risc5CPU/vivado201704/Risc5CPU.cache/compile_simlib/activehdl"
  fi
