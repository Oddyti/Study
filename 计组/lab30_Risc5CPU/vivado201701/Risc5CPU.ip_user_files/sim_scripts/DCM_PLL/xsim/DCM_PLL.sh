...
#
# Generated by Vivado on Fri Sep 27 14:25:25 +0800 2019
...
# Script info
echo -e "DCM_PLL.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DCM_PLL xil_defaultlib.DCM_PLL xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim DCM_PLL -key {Behavioral:sim_1:Functional:DCM_PLL} -tclbatch cmd.tcl -log simulate.log
}
