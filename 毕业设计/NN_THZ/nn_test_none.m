...
input_data = real(train_data_mt(1:mem_n,:));
target_data = real(train_data_mt(mem_n+1,:));

net = newff(input_data, target_data, [128 128] , { 'logsig' 'purelin' } , 'traingdx' );
...
X_seq_mt_new = real(train_data_mt(1:mem_n,:));
% NN均衡 
