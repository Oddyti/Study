...
print("plot")
plt.figure(2)
plt.plot(np.arange(len(Y_pred_real)), Y_pred_real,
         color='blue', label="pred real")
plt.plot(np.arange(len(Y_pred_real)), Y_test_real,
         color='red', label="label real")
plt.plot(np.arange(len(Y_pred_real)), X_real_new,
         color='brown', label="test real")
plt.legend()
plt.xlim(0, 30)
plt.show()
